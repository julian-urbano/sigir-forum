...
\begin{checklist}
\cb{Use the latest version of the template, available from the Github repository.\footnote{\url{https://github.com/julian-urbano/sigir-forum/releases/latest}}}
...
\cb{In-text URLs written as footnotes.}
\cb{In-text email addresses written with \texttt{\textbackslash email}.}
\cb{No use of \texttt{\textbackslash paragraph}.}
\cb{No use of inline enumerations.}
\cb{Dissertation abstracts:}
	\begin{checklist}
...
\cb{Send all files via email to \email{editors_SIGIR@acm.org}.}
\end{checklist}

\subsection*{Comments}
\TextField[multiline,width={17cm},height={10cm},bordercolor={black},borderwidth=0.5pt]{~}
